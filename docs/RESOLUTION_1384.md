...
Issue #1384 was a false positive from the `pipeline-health-cron.sh` monitoring script. The cron detected `HTTP 000` (connection refused) at 2026-09-06 03:02:03 UTC across all 3 retry attempts. This is consistent with a Railway container restart exceeding the 3×30s (~90s) retry window — no actual application outage occurred. This is the twenty-third instance of this false positive pattern.
...
This is the twenty-third instance of this false positive (HTTP 000 / retry-window pattern):
...
| #1384 | 2026-09-06 | Retry window too short (3×30s) | This resolution |

## Evidence

- **No code changes on 2026-09-05 to 2026-09-06** that would trigger a crash. Last deployment was commit `cc48e40` (docs only for #1383).
...
- **Site confirmed live** — HTTP 200 verified at time of investigation (2026-09-06).
...
- Issues #1338–#1382 — same pattern (retry window too short)
