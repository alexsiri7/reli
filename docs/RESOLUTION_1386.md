...
Issue #1386 was a false positive from the `pipeline-health-cron.sh` monitoring script. The cron detected `HTTP 000` (connection refused) at 2026-09-07 03:02:04 UTC across all 3 retry attempts. This is consistent with a Railway container restart exceeding the 3×30s (~90s) retry window — no actual application outage occurred. This is the twenty-fourth instance of this false positive pattern.
...
This is the twenty-fourth instance of this false positive (HTTP 000 / retry-window pattern):
...
| #1382 | 2026-09-05 | Retry window too short (3×30s) | Documented in RESOLUTION_1382 |
| #1384 | 2026-09-06 | Retry window too short (3×30s) | Documented in RESOLUTION_1384 |
| #1386 | 2026-09-07 | Retry window too short (3×30s) | This resolution |

## Evidence

- **No code changes on 2026-09-06 to 2026-09-07** that would trigger a crash. Last deployment was commit `c8dc280` (docs only for #1385).
...
- **Site confirmed live** — HTTP 200 verified at time of investigation (2026-09-07).
...
- Issues #1338–#1384 — same pattern (retry window too short)
