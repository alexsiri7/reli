...
This is the **46th** instance of this identical authentication failure on the prod deploy pipeline, and (continuing the prior investigation's counting convention) the **6th same-day rotation** after #860, #862, #864, #866, and #868 — all filed earlier on 2026-05-02. The day's full set of RAILWAY_TOKEN-rooted issues (broader framing) also includes #858 (03:00 UTC) and the earlier #854 (filed under the "Main CI red" framing) — 8 total today. Throughout this artifact, **"6" = strict chain** (same `Prod deploy failed` filings: #860/#862/#864/#866/#868/#871) and **"8" = broader count** (all RAILWAY_TOKEN-rooted issues today, adding #854 and #858). The PR title and commit message commit to the strict-chain count.
