...
function App() {
  const { currentUser, authChecked, settingsOpen, feedbackOpen, mainView, mobileView, setMobileView, fetchCurrentUser, fetchThingTypes, fetchThings, fetchBriefing, fetchHistory, fetchDailyStats, fetchCalendarStatus, fetchProactiveSurfaces, fetchBlockerAlerts, fetchMergeSuggestions, fetchUserSettings, error } = useStore(
    useShallow(s => ({
      ...
      fetchBlockerAlerts: s.fetchBlockerAlerts,
  ...
  useEffect(() => {
    ...
    fetchUserSettings()
    const interval = setInterval(() => { fetchThings(); fetchBriefing(); fetchProactiveSurfaces(); fetchBlockerAlerts() }, 30_000)
  ...
  }, [currentUser, fetchThingTypes, fetchThings, fetchBriefing, fetchHistory, fetchDailyStats, fetchCalendarStatus, fetchProactiveSurfaces, fetchBlockerAlerts, fetchMergeSuggestions, fetchUserSettings])
