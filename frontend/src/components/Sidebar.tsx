...
import type { Thing, SweepFinding, FocusRecommendation, MorningBriefing, WeeklyBriefing } from '../generated/api-types'
...
export function Sidebar() {
  ...
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- intentional: sync local state from store; no cascade risk
