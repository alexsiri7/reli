...
**YOU ARE IN: `reli/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/reli/` (rig root) or other directories
...
**Your mail address:** `reli/polecats/furiosa`
**Your rig:** reli
**Your Witness:** `reli/witness`
...
| Ask Witness for help | `gt mail send reli/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`reli/witness`) when:
...
```bash
gt mail send reli/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
