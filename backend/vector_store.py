...
def _check_where_fragments(clauses: list[str]) -> None:
    """SEC-12: raise if any clause is not in the server-controlled allowlist."""
...
def vector_search(
    ...
    _check_where_fragments(where_clauses)
