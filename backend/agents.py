...
CONTEXT_AGENT_SYSTEM = (_PROMPTS_DIR / "context-agent.md").read_text()
...
CONTEXT_REFINEMENT_SYSTEM = (_PROMPTS_DIR / "context-refinement-agent.md").read_text()
...
REASONING_AGENT_SYSTEM = (_PROMPTS_DIR / "reasoning-agent.md").read_text()
...
RESPONSE_AGENT_SYSTEM = (_PROMPTS_DIR / "response-agent.md").read_text()
